...
use crate::resolve::{self, resolve_path};
...
pub fn cjs_to_esm(file_name: &str, compile_options: &CompileOptions) -> impl Fold + VisitMut {
  as_folder(CjsToEsm {
    specifiers: vec![],
...
mod tests {
  ...
  fn it_works() {
    ...
    let file_name = format!(
      "{}/{}",
      current_dir, "__tests__/fixtures/condition-require.js"
    );
