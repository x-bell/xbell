...
// import { XBellTestGroupRecord, XBellTestCaseRecord, XBellTestCaseStatus } from '../../lib/index';
...
//   alignItems: 'center',
// });
// interface GroupCardProps extends XBellTestGroupRecord {
...
//   const status = getStatus(cases as XBellTestCase);
//   const [activeCase, setActiveCase] = React.useState<XBellTestCaseRecord>(null);
//   const videoSrc = activeCase?.videoRecords[0]?.filepath;
//   const account = cases.reduce((acc, c: XBellTestCaseRecord) => {
//     if (c.status === 'failed') {
//       acc.failed++;
...
//   const handleVideoClick = (c: XBellTestCaseRecord) => {
//     setActiveCase(c);
