...
export function activate(context: vscode.ExtensionContext) {
	console.log('Congratulations, your extension "bell-vsc-extension" is now active!');

	// const config = vscode.workspace.getConfiguration('bell-vsc-extension');
	...
	// let disposable = vscode.commands.registerCommand('bell-vsc-extension.helloWorld', () => {
	// 	// The code you place here will be executed every time your command is executed
	// 	// Display a message box to the user
	// 	vscode.window.showInformationMessage('Hello World from bell-vsc-extension!');
	// });
